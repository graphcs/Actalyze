...
// Sample cases with CORRECT CaseCompass taxonomy IDs from official JSON
const SAMPLE_CASES: CaseworkRequest[] = [
  {
    ...
    relatedAgency: "US Citizenship and Immigration Services (USCIS)",
    ...
    caseCompass: {
      ...
      tier3: { label_id: "FAM3", name: "Family Petition" },
      tier4: null,
      categoryPath: "DHS > USCIS > Family Petition",
      categoryIds: ["DHS1", "USCIS2", "FAM3"],
      confidence: 95,
      reasoning: "Family petition case (spouse visa) with USCIS processing delay.",
  ...
  },
  {
    ...
    phone: "(555) 345-6789",
    category: "VA",
    subcategory: "Compensation & Pension",
    ...
    caseCompass: {
      ...
      tier3: { label_id: "VA3SUB3", name: "VA subcategory 3" },
      tier4: { label_id: "CMPP4", name: "Compensation & Pension", description: "Service-connected disability compensation claims" },
      categoryPath: "VA > VBA > VA subcategory 3 > Compensation & Pension",
      categoryIds: ["VA1", "VBA2", "VA3SUB3", "CMPP4"],
      confidence: 98,
  ...
  },
  {
    ...
    caseCompass: {
      ...
      tier2: { label_id: "SSA2SUB1", name: "SSA subcategory 1" },
      tier3: { label_id: "SSAMCR3", name: "Medicare" },
      tier4: { label_id: "MDEN4", name: "Medicare Enrollment", description: "Medicare enrollment issues" },
      categoryPath: "SSA > SSA subcategory 1 > Medicare > Medicare Enrollment",
      categoryIds: ["SSA1", "SSA2SUB1", "SSAMCR3", "MDEN4"],
      confidence: 92,
      reasoning: "SSA Medicare enrollment error case requiring disenrollment.",
  ...
  },
  {
    ...
    caseCompass: {
      ...
      tier2: { label_id: "SBA2SUB1", name: "SBA subcategory 1" },
      tier3: { label_id: "SBA3SUB2", name: "SBA subcategory 2" },
      tier4: { label_id: "EIDLL4", name: "EIDL loans", description: "Economic Injury Disaster Loans" },
      categoryPath: "SBA > SBA subcategory 1 > SBA subcategory 2 > EIDL loans",
      categoryIds: ["SBA1", "SBA2SUB1", "SBA3SUB2", "EIDLL4"],
      confidence: 85,
  ...
  },
  {
    ...
    category: "HUD",
    subcategory: "Landlord Complaints",
    ...
    aiRouting: {
      ...
      confidence: 90,
      reasoning: "Fair housing complaint involving disability rights and service animal accommodation. Extended investigation timeline warrants congressional inquiry to HUD.",
      suggestedActions: [
        "Contact HUD Office of Field Policy and Management",
    ...
    caseCompass: {
      tier1: { label_id: "HUD1", name: "Housing and Urban Development (HUD)", abbreviation: "HUD" },
      tier2: { label_id: "OFFPM2", name: "Office of Field Policy and Management" },
      tier3: { label_id: "HOUS3", name: "Private housing" },
      tier4: { label_id: "HLLC4", name: "Landlord complaints", description: "Complaints against landlords" },
      categoryPath: "HUD > Office of Field Policy and Management > Private housing > Landlord complaints",
      categoryIds: ["HUD1", "OFFPM2", "HOUS3", "HLLC4"],
      confidence: 90,
      reasoning: "HUD private housing landlord complaint involving disability discrimination.",
      suggestedActions: ["Contact HUD OFFPM", "Request case status", "Document discrimination incidents"],
      relatedAgency: "Housing and Urban Development (HUD)",
      estimatedTimeline: "2-3 weeks",
      caseCompassVersion: "1.0.2",
      taxonomySource: "House Digital Service"
    }
