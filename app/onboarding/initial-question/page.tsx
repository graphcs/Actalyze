...
export default function InitialQuestionPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg h-screen flex flex-col gap-y-10 relative z-10">
              ...
              <div className="space-y-3">
                {reasons.map((reason) => (
                  <button
                    ...
                    className={`w-full py-2 md:py3 px-6 text-xl text-nowrap rounded-full text-dark font-medium transition-all duration-100`}
                    style={{
